// ============================================================
// admin.js — Upgraded Administrative Dashboards Logic
// ============================================================
...
function showAdminApp(user) {
  ...
  const emailLabel = document.querySelector('.admin-user-email');
...
async function loadSection(name) {
  ...
  if (main) main.innerHTML = '<div class="loading-state"><div class="spinner"></div><span>Loading administrative data…</span></div>';

  try {
    await sec.fn(main);
  } catch (err) {
    if (main) main.innerHTML = `<div class="error-state">Error loading section: ${err.message}</div>`;
  }
}
...
// Upcoming products and SaaS Timers
