...
// Get these from your Supabase project settings (Project > API > Project URL & anon key)
const SUPABASE_URL  = 'https://zplkfwnfwkhjdiylchzh.supabase.co';
const SUPABASE_ANON = 'sb_publishable_vRY7Hso8cw4L--PECFlI0Q_oRbvgxqY';
...
console.log(`📡 Supabase Status: ${isSupabaseConfigured ? '✅ Configured' : '⚠️ Using LocalStorage (Supabase not configured)'}`);
...
const MOCK_DATA = {
  settings: [
    ...
    { key: 'footer_address', value: 'Bangladesh' },
    { key: 'company_name', value: 'Nexdiv Bd' },
    { key: 'whatsapp_number', value: '8801700000000' },
    // USD Domain Pricing
    { key: 'domain_price_com_usd', value: '9.99' },
    { key: 'domain_price_net_usd', value: '11.99' },
    { key: 'domain_price_org_usd', value: '12.99' },
    { key: 'domain_price_xyz_usd', value: '1.99' },
    { key: 'domain_price_info_usd', value: '4.99' },
    // BDT Domain Pricing
    { key: 'domain_price_com_bdt', value: '850' },
    { key: 'domain_price_net_bdt', value: '1000' },
    { key: 'domain_price_org_bdt', value: '1100' },
    { key: 'domain_price_xyz_bdt', value: '170' },
    { key: 'domain_price_info_bdt', value: '420' },
    // Theme Settings
    { key: 'default_theme', value: 'dark' },
    { key: 'primary_color', value: '#6dffe0' },
    { key: 'secondary_color', value: '#a07cff' },
    { key: 'accent_color', value: '#1e90ff' },
    { key: 'theme_toggle_enabled', value: 'true' }
  ],
  services: [
